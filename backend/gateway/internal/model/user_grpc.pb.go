...
type UserServiceClient interface {
	...
	GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListUserResponse, error)
}
...
func (c *userServiceClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	GetAll(context.Context, *emptypb.Empty) (*ListUserResponse, error)
...
func (UnimplementedUserServiceServer) GetAll(context.Context, *emptypb.Empty) (*ListUserResponse, error) {
